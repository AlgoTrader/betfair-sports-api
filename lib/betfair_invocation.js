...
// set Cookie before invocation sent
BetfairInvocation.prototype.setCookie = function(cookie) {
    var self = this;
    self.requestCookie = cookie;
}

// get Cookie after invocation finished
BetfairInvocation.prototype.getCookie = function() {
    var self = this;
