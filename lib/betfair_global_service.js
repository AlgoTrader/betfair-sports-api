...
var globalService = betfairInvocation.services.global;

// Betfair login invocation
exports.login = function(request) {
    return betfairInvocation.invocation(globalService, "login", request);
}

exports.logout = function(request) {
    return betfairInvocation.invocation(globalService, "logout", request);
}

exports.keepAlive = function(request) {
    return betfairInvocation.invocation(globalService, "keepAlive", request);
}
