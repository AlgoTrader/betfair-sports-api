var newBetfairPrice = require('../lib/betfair_price.js').newBetfairPrice;

console.log("Betfair price extreme values:")
console.log('Price below 1.01 test: %s', newBetfairPrice(1.0).toString());
console.log('Price below above 1000 test: %s', newBetfairPrice(1001.0).toString());

console.log("Test rounding of betfair prices:")
console.log('Price 1.01-2.00 rounded to 0.01    %s', newBetfairPrice(1.1134567).toString());
console.log('Price 2.00-3.00 rounded to 0.02    %s', newBetfairPrice(2.2345678).toString());
console.log('Price 3.00-4.00 rounded to 0.05    %s', newBetfairPrice(3.2345678).toString());
console.log('Price 4.00-6.00 rounded to 0.1     %s', newBetfairPrice(4.1345678).toString());
console.log('Price 6.00-10.00 rounded to 0.2    %s', newBetfairPrice(7.2345678).toString());
console.log('Price 10.00-20.00 rounded to 0.5   %s', newBetfairPrice(11.678901).toString());
console.log('Price 20.00-30.00 rounded to 1     %s', newBetfairPrice(21.2345678).toString());
console.log('Price 30.00-50.00 rounded to 2     %s', newBetfairPrice(31.2345678).toString());
